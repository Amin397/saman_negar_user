...
class _RichAlertDialogState extends State<RichAlertDialog> {
  Map<int, AssetImage> _typeAsset = {
    RichAlertType.ERROR: AssetImage("assets/icon/error.png"),
    RichAlertType.SUCCESS: AssetImage("assets/icon/success.png"),
    RichAlertType.WARNING: AssetImage("assets/icon/warning.png"),
  };
                      ...
                      child: Container(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              SizedBox(height: dialogHeight / 5),
                              widget.alertTitle,
                              SizedBox(height: dialogHeight / 14),
                              Padding(padding: EdgeInsets.all(10.0),child: widget.alertSubtitle,),
